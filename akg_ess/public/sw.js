...
const CACHE_VERSION = 'akg-ess-v42';
...
const APP_SHELL = [
  '/ess',
  '/assets/akg_ess/styles.css?v=42',
  '/assets/akg_ess/data.js?v=42',
  '/assets/akg_ess/api.js?v=42',
  '/assets/akg_ess/ui.jsx?v=42',
  '/assets/akg_ess/attendance.jsx?v=42',
  '/assets/akg_ess/monthly-report.jsx?v=42',
  '/assets/akg_ess/leaves.jsx?v=42',
  '/assets/akg_ess/petty.jsx?v=42',
  '/assets/akg_ess/profile.jsx?v=42',
  '/assets/akg_ess/notifications.jsx?v=42',
