...
const CACHE_VERSION = 'akg-ess-v67';
...
const APP_SHELL = [
  '/ess',
  '/assets/akg_ess/styles.css?v=67',
  '/assets/akg_ess/data.js?v=67',
  '/assets/akg_ess/api.js?v=67',
  '/assets/akg_ess/ui.jsx?v=67',
  '/assets/akg_ess/attendance.jsx?v=67',
  '/assets/akg_ess/monthly-report.jsx?v=67',
  '/assets/akg_ess/leaves.jsx?v=67',
  '/assets/akg_ess/petty.jsx?v=67',
  '/assets/akg_ess/profile.jsx?v=67',
  '/assets/akg_ess/notifications.jsx?v=67',
  '/assets/akg_ess/missed-checkout.jsx?v=67',
