...
const CACHE_VERSION = 'akg-ess-v76';
...
const APP_SHELL = [
  '/ess',
  '/assets/akg_ess/styles.css?v=76',
  '/assets/akg_ess/data.js?v=76',
  '/assets/akg_ess/api.js?v=76',
  '/assets/akg_ess/ui.jsx?v=76',
  '/assets/akg_ess/attendance.jsx?v=76',
  '/assets/akg_ess/monthly-report.jsx?v=76',
  '/assets/akg_ess/leaves.jsx?v=76',
  '/assets/akg_ess/petty.jsx?v=76',
  '/assets/akg_ess/profile.jsx?v=76',
  '/assets/akg_ess/notifications.jsx?v=76',
  '/assets/akg_ess/missed-checkout.jsx?v=76',
