...
const CACHE_VERSION = 'akg-ess-v66';
...
const APP_SHELL = [
  '/ess',
  '/assets/akg_ess/styles.css?v=66',
  '/assets/akg_ess/data.js?v=66',
  '/assets/akg_ess/api.js?v=66',
  '/assets/akg_ess/ui.jsx?v=66',
  '/assets/akg_ess/attendance.jsx?v=66',
  '/assets/akg_ess/monthly-report.jsx?v=66',
  '/assets/akg_ess/leaves.jsx?v=66',
  '/assets/akg_ess/petty.jsx?v=66',
  '/assets/akg_ess/profile.jsx?v=66',
  '/assets/akg_ess/notifications.jsx?v=66',
  '/assets/akg_ess/missed-checkout.jsx?v=66',
