...
const CACHE_VERSION = 'akg-ess-v43';
...
const APP_SHELL = [
  '/ess',
  '/assets/akg_ess/styles.css?v=43',
  '/assets/akg_ess/data.js?v=43',
  '/assets/akg_ess/api.js?v=43',
  '/assets/akg_ess/ui.jsx?v=43',
  '/assets/akg_ess/attendance.jsx?v=43',
  '/assets/akg_ess/monthly-report.jsx?v=43',
  '/assets/akg_ess/leaves.jsx?v=43',
  '/assets/akg_ess/petty.jsx?v=43',
  '/assets/akg_ess/profile.jsx?v=43',
  '/assets/akg_ess/notifications.jsx?v=43',
