...
const CACHE_VERSION = 'akg-ess-v40';
...
const APP_SHELL = [
  '/ess',
  '/assets/akg_ess/styles.css?v=40',
  '/assets/akg_ess/data.js?v=40',
  '/assets/akg_ess/api.js?v=40',
  '/assets/akg_ess/ui.jsx?v=40',
  '/assets/akg_ess/attendance.jsx?v=40',
  '/assets/akg_ess/monthly-report.jsx?v=40',
  '/assets/akg_ess/leaves.jsx?v=40',
  '/assets/akg_ess/petty.jsx?v=40',
  '/assets/akg_ess/profile.jsx?v=40',
  '/assets/akg_ess/notifications.jsx?v=40',
