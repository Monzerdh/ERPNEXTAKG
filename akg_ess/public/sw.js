...
const CACHE_VERSION = 'akg-ess-v34';
...
const APP_SHELL = [
  '/ess',
  '/assets/akg_ess/styles.css?v=34',
  '/assets/akg_ess/data.js?v=34',
  '/assets/akg_ess/api.js?v=34',
  '/assets/akg_ess/ui.jsx?v=34',
  '/assets/akg_ess/attendance.jsx?v=34',
  '/assets/akg_ess/monthly-report.jsx?v=34',
  '/assets/akg_ess/leaves.jsx?v=34',
  '/assets/akg_ess/petty.jsx?v=34',
  '/assets/akg_ess/profile.jsx?v=34',
  '/assets/akg_ess/notifications.jsx?v=34',
